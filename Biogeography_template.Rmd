...
env.stack <- stack(paste0(wd$output, 'predictors/env_stack/BCM1981_2010_CFP_Stack.grd'))
names(env.stack)
```
...
cfp <- st_read(paste0(wd$data,'shapefiles/CFP/CFP_GIS.shp')) # California Floristic Province shapefile
